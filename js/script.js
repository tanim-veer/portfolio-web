...
const EN = {
    ...
    sk_anomaly: "Anomaly detection",
    sk_sql: "Analytical SQL (window functions, CTEs)",
    ...
    p14_title: "Fuel price observatory",
    p14_desc: "PostgreSQL database of 5.3 million official prices: data modelling, ETL loading, data quality checks, advanced SQL analytics and measured indexes.",
    p13_title: "Vigie — system monitoring",
    p13_desc: "Monitors a Linux machine by reading /proc directly and detects anomalies in real time (z-score and Isolation Forest), with a web dashboard.",
